...
const fetchLatestVideo = async () => {
  ...
  const url = `https://www.googleapis.com/youtube/v3/search?key=AIzaSyDkKrMwC91QDtre1-PTA8wQsdtdV_6OTKY&channelId=UCShooJom3QCkrDj-skeRi2w&order=date&part=snippet&type=video`;
